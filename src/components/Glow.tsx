...
/** The dome behind the start button. Coordinates are relative to the ACTION frame. */
export const START_GLOW: Layer[] = [
  ...
  { x: 148, y: 152, w: 144, h: 228, color: "#613005", blur: 16, radius: 80 },
  { x: 160, y: 172, w: 120, h: 188, color: "#130901", blur: 16 },
];
